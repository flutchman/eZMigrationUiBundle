...
use EzSystems\EzPlatformAdminUi\Behat\Helper\Environment;
...
use Flutchman\EzMigrationUiBundle\Behat\PageElement\ElementFactory as CustomElementFactory;
...
class Hooks extends RawMinkContext
{
    ...
    public function setInstallTypeBeforeScenario()
    {
        ...
        CustomElementFactory::setInstallType($installType);
